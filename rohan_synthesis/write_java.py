...
class Write_Java:
    ...
    def program_synthesize_from_json(self, json_input,
        ...
        prog += json_input['return_type'] + " generatedProgram" + "("  #
    ...
    def handle_DVarDecl(self, js, var_id, tab_len=0):
    ...
    def synthesize_body_from_json(self, json_array, tab_len=0, variable_count=0):
        ...
        for js in json_array:
            ...
            elif js["node"] in [DVarDecl.name(), DExceptionVarDecl.name()]:
                output_prog += self.handle_DVarDecl(js, tab_len=tab_len, var_id=variable_count)
                variable_count += 1
...
json_ast = {"ast": {"node": "DSubTree", "_nodes": [{"node": "DBranch", "_cond": [{"node": "DAPICall", "_throws": [], "_returns": "boolean", "_call": "java.util.Map.isEmpty()"}], "_else": [], "_then": [{"node": "DAPICall", "_throws": [], "_returns": "java.lang.Object", "_call": "java.util.Map.put(java.lang.Object,java.lang.Object)"}, {"node": "DAPICall", "_throws": [], "_returns": "java.lang.Object", "_call": "java.util.Map.put(java.lang.Object,java.lang.Object)"}, {"node": "DAPICall", "_throws": [], "_returns": "java.lang.Object", "_call": "java.util.Map.put(java.lang.Object,java.lang.Object)"}, {"node": "DAPICall", "_throws": [], "_returns": "java.lang.Object", "_call": "java.util.Map.put(java.lang.Object,java.lang.Object)"}, {"node": "DAPICall", "_throws": [], "_returns": "java.lang.Object", "_call": "java.util.Map.put(java.lang.Object,java.lang.Object)"}]}]}, "formal_params": [], "return_type": "void"}

wjava = Write_Java()
print(wjava.program_synthesize_from_json(json_ast))