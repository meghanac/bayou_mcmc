...
exp = Experiments(data_dir_name, model_dir_path, exp_dir_name, num_iterations, save_mcmc_progs=False, train_test_set_dir_name='/train_test_sets_new_ex/')

exp.run_mcmc(EX_CS, NEW, save_run=False, num_test_progs=5, verbose=False)