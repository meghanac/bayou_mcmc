...
def print_summary_logs(prog):
    ...
    print("\n", "-------------------LOGS:-------------------")
    print("Constraints:", prog.constraints + prog.constraint_control_structs)
    print("Exclude: " + str(prog.exclusions))
    print("Min Length: " + str(prog.min_length))
    print("Max Length: " + str(prog.max_length))
    ...
    post_dist = get_str_posterior_distribution(prog)
    for str_prog in post_dist.keys():
        print('\t', str_prog[0])
        print('\t', str_prog[1])
        print('\t', str_prog[2])
        print('\t', post_dist[str_prog])
        print("\n")
...
class MCMCProgramWrapper:
    ...
    def save_summary_logs(self, logs_f):
        ...
        logs_f.write("\n\n\n-----------------------------------------------------------------------------")
        logs_f.write("\nConstraints: " + str(self.prog.constraints + self.prog.constraint_control_structs))
        logs_f.write("\nExclude: " + str(self.prog.exclusions))
        logs_f.write("\nMin Length: " + str(self.prog.min_length))
        logs_f.write("\nMax Length: " + str(self.prog.max_length))
