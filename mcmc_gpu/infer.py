...
class BayesianPredictor(object):
    ...
    def get_mean_std_initial_state_latent_state(self, nodes, edges, return_type, formal_params):
        feed = {self.model.edges.name: edges, self.model.nodes.name: nodes,
                self.model.return_type: return_type,
                self.model.formal_params: formal_params}
        initial_state, latent_state, mean, std_dev = self.sess.run(
            [self.model.initial_state, self.model.latent_state, self.model.encoder.output_mean, self.model.encoder.output_covar], feed)
        return mean, std_dev, initial_state, latent_state
